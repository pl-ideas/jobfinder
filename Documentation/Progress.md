...
- Chose a Python-first implementation.
...
1. Validate the first source adapter against live source data.
...
Keep this file updated as major decisions are made, source adapters are added, or implementation risks change.
